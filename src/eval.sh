...
# Settings
FINE_TUNE=false
ROOT_NAME=abs_bert_amidialsum_bertextabsWeights_lrbert0.0002  # abs_bert_amidialsum_longer  # abs_bert_amidialsum_bertextabsWeights
ROOT_NAME_MODEL=amidialsum_model_bertextabsWeights_lrbert0.0002  # amidialsum_model_longer  # amidialsum_model_bertextabsWeights
TRAIN_STEPS=10000  # 4000
N_GPU=0

# Parameters
TEST_FROM="../models/${ROOT_NAME_MODEL}/model_step_${TRAIN_STEPS}.pt"
MODEL_PATH="../models/${ROOT_NAME_MODEL}"
LOG_FILE="../logs/test_${ROOT_NAME}_${TRAIN_STEPS}"
